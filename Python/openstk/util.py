...
def _np_createScale4x4(scale: float) -> np.matrix:
    return np.array([
        [scale, 0., 0., 0.],
        [0., scale, 0., 0.],
        [0., 0., scale, 0.],
...
#ref https://github.com/microsoft/referencesource/blob/master/System.Numerics/System/Numerics/Matrix4x4.cs
def _np_createLookAt4x4(cameraPosition: np.ndarray, cameraTarget: np.ndarray, cameraUpVector: np.ndarray) -> np.matrix:
...
#ref https://github.com/microsoft/referencesource/blob/master/System.Numerics/System/Numerics/Matrix4x4.cs
def _np_createPerspectiveFieldOfView4x4(fieldOfView: float, aspectRatio: float, nearPlaneDistance: float, farPlaneDistance: float) -> np.matrix:

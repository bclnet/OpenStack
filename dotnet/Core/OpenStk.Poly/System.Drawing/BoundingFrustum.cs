...
/// <remarks>Creates a bounding sphere whose elements have the specified values.</remarks>
/// <param name="frustum">The value to assign to the <see cref="System.Drawing.BoundingFrustum.Frustum" /> field.</param>
public struct BoundingFrustum(Matrix4x4 frustum) : IEquatable<BoundingFrustum>, IFormattable {
    /// <summary>The Frustum component of the BoundingFrustum.</summary>
    public Matrix4x4 Frustum = frustum;
    ...
    public override readonly bool Equals([NotNullWhen(true)] object? obj) => (obj is BoundingFrustum other) && Equals(other);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly bool Equals(BoundingFrustum other) => Frustum.Equals(other.Frustum);

    /// <summary>Returns the hash code for this instance.</summary>
    /// <returns>The hash code.</returns>
    public override readonly int GetHashCode() => HashCode.Combine(Frustum);

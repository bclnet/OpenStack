...
/// <remarks>Creates a point whose elements have the specified values.</remarks>
...
public struct Point3D(int x, int y, int z) : IEquatable<Point3D>, IFormattable {
    ...
    public override readonly bool Equals([NotNullWhen(true)] object? obj) => (obj is Point3D other) && Equals(other);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly bool Equals(Point3D other) => X.Equals(other.X)
        && Y.Equals(other.Y)
        && Z.Equals(other.Z);

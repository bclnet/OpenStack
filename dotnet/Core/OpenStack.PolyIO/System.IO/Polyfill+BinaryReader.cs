...
public static partial class Polyfill {
    ...
    /// </summary>
    public static uint ReadUIntV8(this BinaryReader source) {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)] public static T[] ReadLV8FArray<T>(this BinaryReader source, Func<BinaryReader, T> factory, bool endian = false, T[] obj = default) => ReadFArray(source, factory, (int)source.ReadUIntV8X(endian), obj);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)] public static T[] ReadLV8PArray<T>(this BinaryReader source, string pat, bool endian = false, T[] obj = default) where T : struct => ReadPArray<T>(source, pat, (int)source.ReadUIntV8X(endian), obj);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)] public static T[] ReadLV8SArray<T>(this BinaryReader source, int sizeOf = 0, bool endian = false, T[] obj = default) where T : struct => ReadSArray<T>(source, (int)source.ReadUIntV8X(endian), sizeOf, obj);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)] public static List<T> ReadLV8FList<T>(this BinaryReader source, Func<BinaryReader, T> factory, bool endian = false, List<T> obj = default) => ReadFList(source, factory, (int)source.ReadUIntV8X(endian), obj);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)] public static List<T> ReadLV8PList<T>(this BinaryReader source, string pat, bool endian = false, List<T> obj = default) where T : struct => ReadPList<T>(source, pat, (int)source.ReadUIntV8X(endian), obj);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)] public static List<T> ReadLV8SList<T>(this BinaryReader source, int sizeOf = 0, bool endian = false, List<T> obj = default) where T : struct => ReadSList<T>(source, (int)source.ReadUIntV8X(endian), sizeOf, obj);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)] public static IDictionary<TKey, TValue> ReadLV8FMany<TKey, TValue>(this BinaryReader source, Func<BinaryReader, TKey> keyFactory, Func<BinaryReader, TValue> valueFactory, bool endian = false, bool sorted = false, IDictionary<TKey, TValue> obj = default) => ReadFMany(source, keyFactory, valueFactory, (int)source.ReadUIntV8X(endian), sorted, obj);
    ...
    //[MethodImpl(MethodImplOptions.AggressiveInlining)] public static IDictionary<TKey, TValue> ReadLV8TMany<TKey, TValue>(this BinaryReader source, int sizeOf, Func<BinaryReader, TValue> valueFactory, bool endian = false, bool sorted = false, IDictionary<TKey, TValue> obj = default) where TKey : struct => source.ReadTMany<TKey, TValue>(sizeOf, valueFactory, (int)source.ReadUIntV8X(endian), sorted, obj);
    //[MethodImpl(MethodImplOptions.AggressiveInlining)]

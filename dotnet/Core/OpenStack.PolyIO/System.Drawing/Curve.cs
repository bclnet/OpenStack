...
/// <remarks>Creates a curve whose elements have the specified values.</remarks>
...
public class Curve(int preLoop, int postLoop, Curve.Key[] keys) : IEquatable<Curve>, IFormattable {
    /// <summary>
    /// LoopType
    /// </summary>
    ...
    public LoopType PreLoop = (LoopType)preLoop;

    /// <summary>The PostLoop component of the curve.</summary>
    public LoopType PostLoop = (LoopType)postLoop;
    ...
    public override bool Equals([NotNullWhen(true)] object? obj) => (obj is Curve other) && Equals(other);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public bool Equals(Curve? other) => PreLoop.Equals(other!.PreLoop)
            && PostLoop.Equals(other.PostLoop)
            && Keys.Equals(other.Keys);

    /// <summary>Returns the hash code for this instance.</summary>
    /// <returns>The hash code.</returns>
    public override int GetHashCode() => HashCode.Combine(PreLoop, PostLoop, Keys);

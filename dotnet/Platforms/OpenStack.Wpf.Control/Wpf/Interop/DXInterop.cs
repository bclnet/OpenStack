...
#pragma warning disable IDE1006 // Naming Styles
    ...
    [DllImport("User32.dll")] public static extern IntPtr /* HDC */ GetDC(IntPtr /* HWND */ hWnd);

    [DllImport("User32.dll")] public static extern int ReleaseDC(IntPtr /* HWND */ hWnd, IntPtr /* HDC */ hDC);
    ...
    public static void Direct3DCreate9Ex(uint SdkVersion, out IDirect3D9Ex context) {
        ...
        [DllImport("d3d9.dll")] static extern int Direct3DCreate9Ex(uint SdkVersion, out IDirect3D9Ex ctx);
    }

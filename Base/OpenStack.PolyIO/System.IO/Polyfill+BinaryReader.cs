...
namespace System.IO
{
    public static partial class Polyfill
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public static void Skip(this BinaryReader source, long count) => source.BaseStream.Position += count; //source.BaseStream.Seek(count, SeekOrigin.Current);
